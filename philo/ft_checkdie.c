...
/*   Updated: 2023/04/22 01:23:19 by bsirikam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_checkdie(t_philo *philo)
{
	...
	while (tmp)
	{
		if ((gettime() - tmp->before) - tmp->last_eat > tmp->info.time_to_die && (tmp->count_eat < tmp->info.num_must_eat || tmp->info.num_must_eat == 0))
		{
